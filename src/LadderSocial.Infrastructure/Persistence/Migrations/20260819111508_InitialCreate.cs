        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Friendships_DifferentUsers", "[UserId] <> [FriendUserId]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RecommendationLogs_AspNetUsers_RecommendedUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrenceTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    DueAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RequiresProofImage = table.Column<bool>(type: "bit", nullable: false),
                    ShareWithFriends = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MessageAttachments_AspNetUsers_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarStorageKey = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskCompletions_Tasks_TaskItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_TaskCompletions_TaskCompletionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskProofMedia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskProofMedia_AspNetUsers_OwnerUserId",
                        column: x => x.OwnerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskProofMedia_TaskCompletions_TaskCompletionId",
                        column: x => x.TaskCompletionId,
                        principalTable: "TaskCompletions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostViews_AspNetUsers_ViewerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FriendRequests_SenderUserId_ReceiverUserId_Status",
                table: "FriendRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MessageAttachments_OwnerUserId",
                table: "MessageAttachments",
                column: "OwnerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Posts_TaskCompletionId",
                table: "Posts",
                column: "TaskCompletionId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PostViews_PostId_ViewerUserId",
                table: "PostViews",
                columns: new[] { "PostId", "ViewerUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PostViews_ViewerUserId",
                table: "PostViews",
                column: "ViewerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RecommendationLogs_RecommendedUserId",
                table: "RecommendationLogs",
                column: "RecommendedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_RecommendationLogs_UserId_CreatedAtUtc",
                table: "RecommendationLogs",
                columns: new[] { "UserId", "CreatedAtUtc" });

            migrationBuilder.CreateIndex(
                name: "IX_RecurrenceTypes_Code",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskProofMedia_OwnerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tasks_OwnerUserId_Status_DueAtUtc",
                table: "Tasks",
                columns: new[] { "OwnerUserId", "Status", "DueAtUtc" });
